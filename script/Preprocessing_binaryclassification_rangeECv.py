...
if __name__ == '__main__':
    ...
    for f in sorted(glob.glob("data/SelectedEdges_CorrCoef_rangeECv/*.txt")):
        ...
        for i in range(len(Genelist_GeneExp_th06)):
            ...
            # save matrix
            savepath = f'data_BinaryClassification/ClassificationDataSet_GeneExp_rangeECv_th06/ClassificationDataSet_GeneExp_rangeECv_th06_{drug}_rank_{i+1}.txt'
        ...
        for i in range(len(Genelist_ECv_th06)):
            ...
            # save matrix
            savepath = f'data_BinaryClassification/ClassificationDataSet_ECv_th06/ClassificationDataSet_ECv_th06_{drug}_rank_{i+1}.txt'
        ...
        # save matrix
        savepath = f'data_BinaryClassification/ClassificationDataSet_GeneExp_rangeECv_th06/ClassificationDataSet_GeneExp_rangeECv_th06_{drug}_allgene.txt'
        ...
        # save matrix
        savepath = f'data_BinaryClassification/ClassificationDataSet_ECv_th06/ClassificationDataSet_ECv_th06_{drug}_allgene.txt'
